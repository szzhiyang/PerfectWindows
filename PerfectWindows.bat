...
echo "ConsentPromptBehaviorAdmin"=dword:00000002>>%systemroot%\PerfectWindows\core.reg
...
echo "EnableInstallerDetection"=dword:00000000>>%systemroot%\PerfectWindows\core.reg
